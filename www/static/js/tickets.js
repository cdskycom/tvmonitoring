...
var vm = new Vue({
	...
	methods:{
		...
		updateTroubleTicket:function(event){
			that = this;
			var url = "/api/updatetroubleticket";
			axios.post(url,{
					tid: this.newTrouble.id,
					report_channel: this.newTrouble.report_channel,
					type: this.newTrouble.type,
					region: this.newTrouble.region,
					level: this.newTrouble.level,
		...
		dealTrouble:function(t, flag){
			...
			axios.post('/api/troubleticket/dealingtroublebatch', params
				// {
